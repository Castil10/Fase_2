    ...
    private void EjecutarBusqueda()
    {
        ...
        try
        {
            ...
            var cliente = clientesRepo.GetAll().FirstOrDefault(c =>
                ...
                (c.Documento ?? string.Empty).Contains(q, StringComparison.OrdinalIgnoreCase));
            ...
            var proveedor = proveedoresRepo.GetAll().FirstOrDefault(p =>
                p.Nombre.Contains(q, StringComparison.OrdinalIgnoreCase) ||
                (p.Telefono ?? string.Empty).Contains(q, StringComparison.OrdinalIgnoreCase) ||
                (p.Correo ?? string.Empty).Contains(q, StringComparison.OrdinalIgnoreCase));
